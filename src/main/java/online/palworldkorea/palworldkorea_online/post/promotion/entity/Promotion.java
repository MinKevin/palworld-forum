package online.palworldkorea.palworldkorea_online.post.promotion.entity;
...
@Entity
@NoArgsConstructor
public class Promotion extends CommonPost {
    public Promotion(Member author, @NotBlank String title, @NotBlank String content, List<Attachment> attachments) {
